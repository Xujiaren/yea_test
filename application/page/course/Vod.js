...
class Vod extends Component {
    ...
    constructor(props) {
        ...
        const { course = {}, level_id = 0, planId = 0 } = route.params;
        this.course = course;
    ...
    render() {
        const { navigation } = this.props;
        const { loaded, cy, index, currentPage, canReward, canBuy, mediaId, playUrl, duration, user_integral, preview, preview_index, preview_imgs, collect, collectNum, score, courseScore, teacherScore, cert, certList,share } = this.state;
